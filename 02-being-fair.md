...
- ![](fig/impossible_protocol.png){alt='screenshot of excerpt of the paper stating that standard methods were used without any further detail'}
...
- Whether trying to import the data to CSV, Excel, R, python or any other statistical package, this source is in an incredibly inconvenient format, as you can see in this screenshot showing what happened when we tried to copy-and-paste the data into Excel:  
  ![](fig/data_pasted_into_excel_Screenshot.png){alt='Figure 1b. Impossible average'}
...
Your task is to find the link to the repository containing the raw RNA-seq data described in [Li et al., Genes Dev. 2012](https://genesdev.cshlp.org/content/26/8/785.long).
...
![](fig/results_SRA_search_Screenshot_2022-08-18_180211.png){alt='screenshot showing results of a search of the SRA website using the cited accession number'}
...
![](fig/FAIR.png){alt='Figure 2. logo spelling out F, Findable, A, Accessible, I, Interoperable, R, Re-usable'}
